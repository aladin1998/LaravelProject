    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
             ...
             <form action="{{ url('rep/updateFile/cours/'.$cour->id)}}" method="POST" enctype="multipart/form-data">

                @method('PUT')
                 @csrf
                 <div class="form-group">
                 <label for="formGroupExampleInput"> &nbsp Professeur</label>
                <select name="prof" placeholder="niveau" class="form-control" required>
                ...
                <select name="module" placeholder="niveau" class="form-control" required>
